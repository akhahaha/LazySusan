...
/**
 * Draggable Tinder-style card stack.
 * <p>
 * Built upon Tinder Card Stack View by Ecstasy2.
...
public class CardStackView extends RelativeLayout {
    ...
    private static int MIN_DRAG_DISTANCE = 50;
    private static int MIN_ACCEPT_DISTANCE = 40;
    ...
    public void setmProductStackListener(
            ProductStackListener mProductStackListener) {
    ...
    private void scaleAndTranslate(int cardIndex, View view) {
        ...
        if (view == mBeingDragged) {
            ...
            float progress = Math.min(Math.abs(mXDelta)
                    / ((float) mMinAcceptDistance * 5), 1);
            float angleDegree = MAX_ANGLE_DEGREE
        ...
        if (mBeingDragged != null) {
            ...
            float distance = (float) Math.sqrt(mXDelta * mXDelta + mYDelta
                    * mYDelta);
        ...
        float translateStep = (int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, PADDING_TOP,
                        r.getDisplayMetrics());
    ...
    private void setup() {
        Resources r = getContext().getResources();
        mMinDragDistance = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, MIN_DRAG_DISTANCE,
                r.getDisplayMetrics());
        mMinAcceptDistance = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, MIN_ACCEPT_DISTANCE,
                r.getDisplayMetrics());
    ...
    private void initializeStack() {
        int position = 0;
        // fixed: possible fix for the unusual error of the 4th product
        // repeating, mCurrentPosition + STACK_SIZE -1 or
        // fixed: mCurrentPosition += position instead of position - 1, in the
        ...
        public boolean onTouch(final View view, MotionEvent motionEvent) {
            ...
            switch (action & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!canAcceptChoice()) {
                        ...
                        ObjectAnimator yTranslation = ObjectAnimator.ofFloat(
                                mBeingDragged, "translationY", 0);
                        ObjectAnimator xTranslation = ObjectAnimator.ofFloat(
                                mBeingDragged, "translationX", 0);
                        ...
                        set.addListener(new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                ...
                                if (mProductStackListener != null) {
                                    mProductStackListener
                                            .onCancelled(finalView);
                                }
                            }
                        });
                        ...
                        ObjectAnimator animation = ObjectAnimator.ofFloat(last,
                                "translationX", sign * 1000).setDuration(300);
                        animation.addListener(new AnimatorListenerAdapter() {
                            @Override
                            public void onAnimationEnd(Animator animation) {
                                if (mProductStackListener != null) {
                                    boolean choice = finalChoice;
                                    mProductStackListener.onChoiceMade(choice,
                                            last);
                                }
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mProductStackListener != null) {
                        mProductStackListener.onUpdateProgress(choiceBoolean,
                                progress, mBeingDragged);
                    }
